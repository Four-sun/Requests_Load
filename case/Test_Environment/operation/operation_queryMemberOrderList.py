...
@author: Four
Project: operation_queryMemberOrderList.py
URL:http://operation-pc-qa.eslink.net.cn/etbc/order/queryMemberOrderList
...
Sheet_Name = "operation_queryMemberOrderList"
logger_message = Logger()

def operation_queryMemberOrderList_1(self):
    u"""查询交易记录"""
    try:
...
class operation_queryMemberOrderList(unittest.TestCase):
        @classmethod
        def setUpClass(cls):
        ...
        def test_operation_queryMemberOrderList(self):
            operation_queryMemberOrderList_1(self)
