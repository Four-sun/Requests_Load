...
@author: Four
Project: case\member_querySuccessCardRecharge
URL: http://member-pc-qa.eslink.net.cn/member/querySuccessCardRecharge
Description:充值成功记录查询接口
"""
import os
import sys
import time
...
Sheet_Name = "member_querySuccessCardRecharge"
logger_message = Logger()
send_time = time.strftime("%Y-%m-%d-%H_%M_%S", time.localtime(time.time()))


class member_querySuccessCardRecharge(unittest.TestCase):
    ...
    def test_member_querySuccessCardRecharge_1(self):
        u"""充值成功记录查询接口"""
        try:
    ...
    def test_member_querySuccessCardRecharge_2(self):
    ...
    def test_member_querySuccessCardRecharge_3(self):
    ...
    def test_member_querySuccessCardRecharge_5(self):
        u"""充值成功记录查询接口,缺少会员ID"""
        try:
            data = ExcelUtil(reportxlsx, Sheet_Name).dict_data()
            test_id = 4
    ...
    def test_member_querySuccessCardRecharge_6(self):
        u"""充值成功记录查询接口,缺少会员卡号"""
        try:
            data = ExcelUtil(reportxlsx, Sheet_Name).dict_data()
            test_id = 5
